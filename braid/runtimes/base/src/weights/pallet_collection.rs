...
//! Autogenerated weights for `pallet_collection`
//!
...
/// Weight functions for `pallet_collection`.
pub struct WeightInfo<T>(PhantomData<T>);
impl<T: frame_system::Config> pallet_collection::WeightInfo for WeightInfo<T> {
