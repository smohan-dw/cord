...
use cord_braid_base_runtime_constants::currency::UNITS;
...
pub fn braid_base_local_testnet_genesis() -> serde_json::Value {
	braid_base_testnet_genesis(
		vec![
...
pub fn braid_base_development_config_genesis() -> serde_json::Value {
	braid_base_testnet_genesis(
