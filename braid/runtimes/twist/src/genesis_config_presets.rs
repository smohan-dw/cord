...
use cord_braid_twist_runtime_constants::currency::UNITS;
...
fn braid_twist_testnet_genesis(
...
pub fn braid_twist_local_testnet_genesis() -> serde_json::Value {
	braid_twist_testnet_genesis(
		vec![
...
pub fn braid_twist_development_config_genesis() -> serde_json::Value {
	braid_twist_testnet_genesis(
